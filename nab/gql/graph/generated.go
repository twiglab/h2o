...
func (e *executableSchema) Complexity(ctx context.Context, typeName, field string, childComplexity int, rawArgs map[string]any) (int, bool) {
	...
	case "Mutation.deviceOnOff":
		...
		args, err := ec.field_Mutation_deviceOnOff_args(ctx, rawArgs)
		if err != nil {
			return 0, false
		}
	...
	case "OnOff.code":
		...
		return e.ComplexityRoot.OnOff.Code(childComplexity), true
	case "OnOff.op":
		if e.ComplexityRoot.OnOff.Op == nil {
			break
		}

		return e.ComplexityRoot.OnOff.Op(childComplexity), true
...
func (e *executableSchema) Exec(ctx context.Context) graphql.ResponseHandler {
	...
	inputUnmarshalMap := graphql.BuildUnmarshalerMap(
		ec.unmarshalInputDeviceOnOffInput,
	)
	first := true
...
//go:embed "schema/onoff.graphqls" "schema/scalar.graphqls"
...
var sources = []*ast.Source{
	{Name: "schema/onoff.graphqls", Input: sourceData("schema/onoff.graphqls"), BuiltIn: false},
...
func (ec *executionContext) childFields_OnOff(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
	switch field.Name {
	case "code":
		return ec.fieldContext_OnOff_code(ctx, field)
	case "op":
		return ec.fieldContext_OnOff_op(ctx, field)
	}
	return nil, fmt.Errorf("no field named %q was found under type OnOff", field.Name)
}
...
func (ec *executionContext) _Mutation_deviceOnOff(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		...
		func(ctx context.Context, field graphql.CollectedField) (*graphql.FieldContext, error) {
			return ec.fieldContext_Mutation_deviceOnOff(ctx, field)
		},
		func(ctx context.Context) (any, error) {
			fc := graphql.GetFieldContext(ctx)
			return ec.Resolvers.Mutation().DeviceOnOff(ctx, fc.Args["input"].(model.DeviceOnOffInput))
		},
		nil,
...
func (ec *executionContext) fieldContext_Mutation_deviceOnOff(ctx context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
...
func (ec *executionContext) _OnOff_code(ctx context.Context, field graphql.CollectedField, obj *model.OnOff) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_OnOff_code(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("OnOff", field, false, false, errors.New("field of type String does not have child fields"))
}

func (ec *executionContext) _OnOff_op(ctx context.Context, field graphql.CollectedField, obj *model.OnOff) (ret graphql.Marshaler) {
	return graphql.ResolveField(
		ctx,
		ec.OperationContext,
		field,
...
func (ec *executionContext) fieldContext_OnOff_op(_ context.Context, field graphql.CollectedField) (fc *graphql.FieldContext, err error) {
	return graphql.NewScalarFieldContext("OnOff", field, false, false, errors.New("field of type String does not have child fields"))
}
...
func (ec *executionContext) unmarshalInputDeviceOnOffInput(ctx context.Context, obj any) (model.DeviceOnOffInput, error) {
	var it model.DeviceOnOffInput
	if obj == nil {
		return it, nil
	}
...
var onOffImplementors = []string{"OnOff"}

func (ec *executionContext) _OnOff(ctx context.Context, sel ast.SelectionSet, obj *model.OnOff) graphql.Marshaler {
	fields := graphql.CollectFields(ec.OperationContext, sel, onOffImplementors)
	...
	for i, field := range fields {
		switch field.Name {
		case "__typename":
			out.Values[i] = graphql.MarshalString("OnOff")
		case "code":
			out.Values[i] = ec._OnOff_code(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		case "op":
			out.Values[i] = ec._OnOff_op(ctx, field, obj)
			if out.Values[i] == graphql.Null {
				out.Invalids++
			}
		default:
...
func (ec *executionContext) unmarshalNDeviceOnOffInput2githubᚗcomᚋtwiglabᚋh2oᚋnabᚋgqlᚋgraphᚋmodelᚐDeviceOnOffInput(ctx context.Context, v any) (model.DeviceOnOffInput, error) {
	res, err := ec.unmarshalInputDeviceOnOffInput(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}
...
func (ec *executionContext) marshalNOnOff2ᚖgithubᚗcomᚋtwiglabᚋh2oᚋnabᚋgqlᚋgraphᚋmodelᚐOnOff(ctx context.Context, sel ast.SelectionSet, v *model.OnOff) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			graphql.AddErrorf(ctx, "the requested element is null which the schema does not allow")
		}
