...
const (
	// Label holds the string label denoting the electy type in the database.
	Label = "electy"
...
// Columns holds all SQL columns for electy fields.
var Columns = []string{
	FieldID,
	FieldCreateTime,
	FieldUpdateTime,
...
// OrderOption defines the ordering options for the Electy queries.
